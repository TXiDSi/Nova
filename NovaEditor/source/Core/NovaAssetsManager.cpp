...
namespace NovaEditor
{
	...
	std::string NovaAssetsManager::GetVertexShaderSource(const std::string& path)
	{
	...
	std::string NovaAssetsManager::GetFragmentShaderSource(const std::string& path)
	{
        std::string fileSource = GetFileSource(path);
